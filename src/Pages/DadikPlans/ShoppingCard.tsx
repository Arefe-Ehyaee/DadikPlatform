...
const ShoppingCard: React.FC<ShoppingCardProps> = ({
  ...
  return (
    <div className="relative flex flex-col w-[325px] h-[541px] border border-primary-300 rounded-2xl bg-[rgba(236,238,248,0.24)] px-6 py-8 mt-10">
      ...
      {sale ? (
        <div className="flex flex-row gap-[2px] justify-center relative mt-2 mb-4">
          <div className="flex flex-row absolute -right-2 justify-center items-center w-[88px] h-10 rounded-lg text-base border bg-primary-50 text-black font-myYekanFaNumMedium py-[9.5]">
            {`${salePercentage} تخفیف`}
          </div>
          <img src={cubeIcon} alt="plan" className="flex justify-center" />
        </div>
      ) : (
        <img
          src={cubeIcon}
          alt="plan"
          className="flex justify-center h-12 w-12 mx-auto mt-2 mb-4"
        />
      )}
