...
export default function TaskModal({isOpen, onClose, onSave, modalDate, modalHour, modalTitle, setModalHour, setModalTitle, hours}:TaskModalProps) {
  return (
    <div
  ...
  >
    ...
    >
      ...
      {/* Date display */}
      <div className="mb-4">
        <label className="block mb-1 font-myYekanMedium text-sm">
          تاریخ:
        </label>
      ...
      {modalHour !== undefined ? (
        // If hour was passed in (Day/Week View), just show it
        <div className="mb-4">
          <label className="block mb-1 font-myYekanMedium text-sm">
            ساعت:
          </label>
        ...
        // If hour is undefined (Month View), let user pick from dropdown
        <div className="mb-4">
          <label className="block mb-1 font-myYekanMedium text-sm">
            ساعت کار:
          </label>
