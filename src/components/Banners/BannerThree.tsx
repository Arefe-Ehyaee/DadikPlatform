  ...
  overflow-hidden rounded-r-2xl rounded-l-[77px] pl-[50px]">
      ...
      <div className="absolute inset-0 flex flex-col text-primary-800 items-start mr-[440px]">
        <h1 className="text-xl font-myYekanDemibold mt-4 mb-3">
          اگر نیازبه وکیل ، کارشناس حقوقی و یا مشاور دارید ، دادیک در کنار شماست
        </h1>
        <div className="mb-3">
          <p className="text-sm font-myYekanRegular ">
            مشاور حقوقی خانواده ، مشاور و وکیل قضایی ، مشاور مالیاتی و شرکتی
          </p>

          <button className='w-[150px] h-6 bg-primary-500 font-myYekanRegular text-sm text-white rounded-[4px] mt-3 mb-[2px] relative z-20'>درخواست وکیل یا مشاور</button>
        </div>
