  ...
  overflow-hidden rounded-r-2xl rounded-l-[77px] pl-[50px]">
      ...
      <div className="absolute inset-0 flex flex-col text-primary-800 items-start mr-[440px]">
        <h1 className="text-xl font-myYekanDemibold mt-4 mb-3">
          با شرکت در دوره های آموزشی و همایش های تخصصی در حوزه کاری خود بروز و خبره شوید
        </h1>
        <div className="mb-3 mr-6">
          <p className="text-sm font-myYekanRegular ">
            <ul className="flex flex-row list-disc gap-8">
              <li>دوره های آموزشی حقوقی </li>
              <li>پک های آموزشی شرکت ها</li>
              <li>پک قانون تجارت </li>
              <li>همایش تخصصی</li>
            </ul>
          </p>

          <button className='w-[116px] h-6 bg-primary-500 font-myYekanRegular text-sm text-white rounded-[4px] mt-3 mb-[2px] relative z-20'>خرید دوره آموزشی</button>
        </div>
