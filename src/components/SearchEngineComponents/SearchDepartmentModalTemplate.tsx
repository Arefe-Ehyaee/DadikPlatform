interface SearchDepartmentModalTemplateProps {
    showModal: boolean;
    onClose?: () => void;
    className?: string;
  ...
  const SearchDepartmentModalTemplate = ({
    showModal,
    onClose,
    className,
    mainComponent,
    children
  }: SearchDepartmentModalTemplateProps) => {
  ...
  export default SearchDepartmentModalTemplate;
